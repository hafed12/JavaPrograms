...
public class Main {
    ...
    public static void addItem(){
        System.out.println("Please enter the item to add to the list.");
    ...
    public static void searchForItem(){
        System.out.println("Enter the searched item");
        String searched = scanner.nextLine();
        if(groceryList.onFile(searched)){
            System.out.println("The item" + searched + " is found in the list.");
        }else{
            System.out.println("The item"+ searched +" is not on file.");
        }
